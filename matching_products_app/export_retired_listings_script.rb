...
attributes = ["Account Id", "SKU", "UPC", "Supplier Url", "Marketplace Url", "Verified Match", "Is Default", "Quantity Multiplier", "Item Id", "Listed Price", "Supplier Price", "Supplier Stock", "Supplier Shipping", "Variation", "Is Mismatch", "Ma Price", "Va Id", "Listing Source", "Error Type", "Error Log"]
